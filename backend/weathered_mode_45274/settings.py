"""
Django settings for weathered_mode_45274 project.
...
ROOT_URLCONF = 'weathered_mode_45274.urls'
...
WSGI_APPLICATION = 'weathered_mode_45274.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_mode_45274 API",
    "DESCRIPTION": "API documentation for weathered_mode_45274 App",
    "VERSION": "v1",
}
